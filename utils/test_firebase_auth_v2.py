...
from utils.test_auth_manager import (
    create_user,
    authenticate_user,
    update_user_canvas,
...
def run_tests():
    ...
    test_user = {
        ...
        'password': TEST_PASSWORD,  # Use the test password
...
def cleanup_test_user(test_user):
    ...
    try:
        ...
        db.collection('users').document(test_user['username']).delete()
